    ...
    <>
      ...
      {ITEMS.map((item, i) => (
        ...
        >
          ...
          {item.action === "stats" && (
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <rect x="3" y="11" width="3.5" height="6" rx="1" fill="#FFFFFF"/>
              <rect x="8.25" y="7" width="3.5" height="10" rx="1" fill="#FFFFFF"/>
              <rect x="13.5" y="4" width="3.5" height="13" rx="1" fill="#FFFFFF"/>
            </svg>
          )}
          <span
            style={{
